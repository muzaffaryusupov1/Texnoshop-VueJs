<template>
	<div className="product-page">
		<div role="status" class="text-center flex items-center justify-center mt-36" v-if="isLoading">
			<svg
				aria-hidden="true"
				class="w-[200px] h-[200px] text-gray-200 animate-spin dark:text-gray-400 fill-black"
				viewBox="0 0 100 101"
				fill="none"
